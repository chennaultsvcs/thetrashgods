...
function dual_button_block_init() {
	...
	/* Common Styles */
	wp_register_style(
		'dual-button-block-style',
		ESSENTIAL_BLOCKS_ADMIN_URL . 'blocks/dual-button/style.css',
		array(),
	...
	register_block_type( 'essential-blocks/dual-button', array(
		...
		'editor_style'  => 'dual-button-block-style',
		'render_callback' => function( $attributes, $content ) {
			if( !is_admin() ) {
				wp_enqueue_style('dual-button-block-style');
			}
		  	return $content;
	  	}
	) );
