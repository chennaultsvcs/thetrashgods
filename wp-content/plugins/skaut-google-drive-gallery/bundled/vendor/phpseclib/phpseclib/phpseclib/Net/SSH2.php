...
use Sgdg\Vendor\phpseclib3\System\SSH\Agent\Identity as AgentIdentity;
...
class SSH2
{
    ...
    private function connect()
    {
        ...
        $extra = $matches[1];
        if (\defined('Sgdg\\Vendor\\NET_SSH2_LOGGING')) {
    ...
    {
        if (\defined('Sgdg\\Vendor\\NET_SSH2_LOGGING') && NET_SSH2_LOGGING == self::LOG_COMPLEX) {
