...
class SFTP extends SSH2
{
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        if (!\defined('Sgdg\\Vendor\\NET_SFTP_QUEUE_SIZE')) {
            \define('Sgdg\\Vendor\\NET_SFTP_QUEUE_SIZE', 32);
        }
        if (!\defined('Sgdg\\Vendor\\NET_SFTP_UPLOAD_QUEUE_SIZE')) {
            \define('Sgdg\\Vendor\\NET_SFTP_UPLOAD_QUEUE_SIZE', 1024);
        }
    }
    /**
     * Login
    ...
    private function send_sftp_packet($type, $data, $request_id = 1)
    {
        ...
        $stop = \microtime(\true);
        if (\defined('Sgdg\\Vendor\\NET_SFTP_LOGGING')) {
